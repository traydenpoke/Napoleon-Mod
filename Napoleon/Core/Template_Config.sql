...
VALUES	('Players:Expansion1_Players',		'CIVILIZATION_TB_FRANCE',		'TB_LEADER_NAPOLEON_BONAPARTE',			'TB_UD_FRANCE_BANQUE',				'ICON_TB_UD_FRANCE_BANQUE',				'LOC_TB_UD_FRANCE_BANQUE_NAME',				'LOC_TB_UD_FRANCE_BANQUE_DESCRIPTION',			20),
		('Players:Expansion1_Players',		'CIVILIZATION_TB_FRANCE',		'TB_LEADER_NAPOLEON_BONAPARTE',			'TB_UU_FRANCE_GARDE',				'ICON_TB_UU_FRANCE_GARDE',				'LOC_TB_UU_FRANCE_GARDE_NAME',				'LOC_TB_UU_FRANCE_GARDE_DESCRIPTION',			10),
		...
		('Players:Expansion2_Players',		'CIVILIZATION_TB_FRANCE',		'TB_LEADER_NAPOLEON_BONAPARTE',			'TB_UD_FRANCE_BANQUE',				'ICON_TB_UD_FRANCE_BANQUE',				'LOC_TB_UD_FRANCE_BANQUE_NAME',				'LOC_TB_UD_FRANCE_BANQUE_DESCRIPTION',			20),
		('Players:Expansion2_Players',		'CIVILIZATION_TB_FRANCE',		'TB_LEADER_NAPOLEON_BONAPARTE',			'TB_UU_FRANCE_GARDE',				'ICON_TB_UU_FRANCE_GARDE',				'LOC_TB_UU_FRANCE_GARDE_NAME',				'LOC_TB_UU_FRANCE_GARDE_DESCRIPTION',			10),
