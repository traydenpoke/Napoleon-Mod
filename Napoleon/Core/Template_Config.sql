...
VALUES	('Players:Expansion1_Players',		'CIVILIZATION_TEMP_CIV_CUSTOM',		'LEADER_TEMP_LEADER_CUSTOM',	'BUILDING_TEMP_CUSTOM',	'ICON_BUILDING_TEMP_CUSTOM',	'LOC_BUILDING_TEMP_CUSTOM_NAME',			'LOC_BUILDING_TEMP_CUSTOM_DESCRIPTION',		30),
		...
		('Players:Expansion2_Players',		'CIVILIZATION_TEMP_CIV_CUSTOM',		'LEADER_TEMP_LEADER_CUSTOM',	'BUILDING_TEMP_CUSTOM',	'ICON_BUILDING_TEMP_CUSTOM',	'LOC_BUILDING_TEMP_CUSTOM_NAME',			'LOC_BUILDING_TEMP_CUSTOM_DESCRIPTION',		30),
